...
ROUTER.add(web.admin.views.users, web.admin.pages.Users.url_regex, 'GET')
...
ROUTER.add(lambda r: ywsgi.redirect(web.admin.pages.Users.url), web.admin.forms.CreateUser.action_regex, 'GET')
